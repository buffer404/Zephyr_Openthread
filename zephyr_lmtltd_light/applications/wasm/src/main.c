...
app_instance_main(wasm_module_inst_t module_inst)
{
    ...
    if (wasm_runtime_lookup_function(module_inst, "main", NULL) //"main", NULL
        || wasm_runtime_lookup_function(module_inst, "__main_argc_argv", //__main_argc_argv
                                        NULL)) {
        ...
        os_printf("return %d\n", wasm_runtime_call_wasm(exec_env, func, 5, argv));
