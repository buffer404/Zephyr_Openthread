...
DEFINE_REG_READ(lqi_val, CC1200_REG_LQI_VAL, true)
DEFINE_REG_READ(marcstate, CC1200_REG_MARCSTATE, true)
DEFINE_REG_READ(marc_status1, CC1200_REG_MARC_STATUS1, true)
