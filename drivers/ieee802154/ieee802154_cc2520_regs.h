...
/* MARC State */
#define CC1200_MARC_STATE_MASK 0x1F

enum CC1200_MARC_STATE
{
	CC1200_MARC_STATE_SLEEP = 0b00000,
	CC1200_MARC_STATE_IDLE,
	CC1200_MARC_STATE_XOFF,
	CC1200_MARC_STATE_BIAS_SETTLE_MC,
	CC1200_MARC_STATE_REG_SETTLE_MC,
	CC1200_MARC_STATE_MANCAL,
	CC1200_MARC_STATE_BIAS_SETTLE,
	CC1200_MARC_STATE_REG_SETTLE,
	CC1200_MARC_STATE_STARTCAL,
	CC1200_MARC_STATE_BWBOOST,
	CC1200_MARC_STATE_FS_LOCK,
	CC1200_MARC_STATE_IFADCON,
	CC1200_MARC_STATE_ENDCAL,
	CC1200_MARC_STATE_RX,
	CC1200_MARC_STATE_RX_END,
	CC1200_MARC_STATE_RXDCM,
	CC1200_MARC_STATE_TXRX_SWITCH,
	CC1200_MARC_STATE_RX_FIFO_ERR,
	CC1200_MARC_STATE_FSTXON,
	CC1200_MARC_STATE_TX,
	CC1200_MARC_STATE_TX_END,
	CC1200_MARC_STATE_RXTX_SWITCH,
	CC1200_MARC_STATE_TX_FIFO_ERR,
	CC1200_MARC_STATE_IFADCON_TXRX
};

enum CC1200_MARC_STATUS
{
	cc1200_marc_status_no_failure,
	cc1200_marc_status_rx_timeout,
	cc1200_marc_status_rx_termination_cs_or_pqt,
	cc1200_marc_status_ewor_sync_lost,
	cc1200_marc_status_discarded_max_len_filter,
	cc1200_marc_status_discarded_adress_filter,
	cc1200_marc_status_discarded_crc_filter,
	cc1200_marc_status_tx_fifo_overflow,
	cc1200_marc_status_tx_fifo_underflow,
	cc1200_marc_status_rx_fifo_overflow,
	cc1200_marc_status_rx_fifo_underflow,
	cc1200_marc_status_tx_on_cca_failed,
	cc1200_marc_status_tx_finished_success = 0x40,
	cc1200_marc_status_rx_finished_success = 0x80,
