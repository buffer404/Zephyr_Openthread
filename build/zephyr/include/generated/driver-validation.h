...
#define Z_SYSCALL_DRIVER_CC_CAPTURE_COMPARE_API(ptr, op) Z_SYSCALL_DRIVER_GEN(ptr, op, cc_capture_compare_api, CC_CAPTURE_COMPARE_API)

#define Z_SYSCALL_DRIVER_LMTMODEM(ptr, op) Z_SYSCALL_DRIVER_GEN(ptr, op, lmtmodem, LMTMODEM)

#define Z_SYSCALL_DRIVER_RADIO(ptr, op) Z_SYSCALL_DRIVER_GEN(ptr, op, radio, RADIO)

#define Z_SYSCALL_DRIVER_RADIO_CONTROLLER_API(ptr, op) Z_SYSCALL_DRIVER_GEN(ptr, op, radio_controller_api, RADIO_CONTROLLER_API)

#define Z_SYSCALL_DRIVER_RADIO_DEVICE(ptr, op) Z_SYSCALL_DRIVER_GEN(ptr, op, radio_device, RADIO_DEVICE)
